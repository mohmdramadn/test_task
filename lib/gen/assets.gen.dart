...
class $AssetsImagesPngsGen {
  ...
  /// File path: assets/images/pngs/black_bg.png
  AssetGenImage get blackBg =>
      const AssetGenImage('assets/images/pngs/black_bg.png');

  /// File path: assets/images/pngs/logo_img.png
  AssetGenImage get logoImg =>
      const AssetGenImage('assets/images/pngs/logo_img.png');

  /// File path: assets/images/pngs/onboarding_bg.png
  AssetGenImage get onboardingBg =>
      const AssetGenImage('assets/images/pngs/onboarding_bg.png');

  /// List of all assets
  List<AssetGenImage> get values => [blackBg, logoImg, onboardingBg];
}
...
class $AssetsImagesSvgsGen {
  ...
  /// File path: assets/images/svgs/logo_h.svg
